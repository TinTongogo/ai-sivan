...
import com.icusu.sivan.application.model.dto.CreateLlmProviderRequest;
import com.icusu.sivan.application.model.dto.LlmProviderResponse;
import com.icusu.sivan.application.model.dto.ModelCapabilityInfo;
import com.icusu.sivan.application.model.dto.UpdateLlmProviderRequest;
...
class LlmProviderServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new LlmProviderService(repository, modelRouter, capabilityRegistry, llmHttpClient);
    }
