...
public class OpenAiModelAdapter implements LanguageModel {
    ...
    private final Model v1Model;

    public OpenAiModelAdapter(Model v1Model, LlmProvider provider) {
    ...
    public Flux<ChatEvent> chat(List<Msg> messages, ModelParams params) {
        ...
        return Flux.concat(
                ...
                v1Model.stream(v1Messages, List.of(), v1Params)
                        .flatMap(chunk -> {
                            // 归约最终结果
